    ...
    def _run(self, state: SystemState):
        ...
        for SQL_meta_info in target_SQL_meta_infos:
            try:
                ...
                SQL_meta_info.need_fixing = True
        need_fixing_SQL_meta_infos = [(index, target_SQL_meta_info) for index, target_SQL_meta_info in
                                      enumerate(target_SQL_meta_infos) if target_SQL_meta_info.need_fixing]
        if len(need_fixing_SQL_meta_infos) > 0:
